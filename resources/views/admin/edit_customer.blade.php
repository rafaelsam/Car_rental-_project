          ...
          <div class="card-header text-success mt-2">
           ...
           <div class="form m-3">
                  @if(Session::has('messej_reg'))
                   ...
                   @endif
                   @if(Session::has('messej_danger'))
                   <div class="alert alert-danger">
                   {{Session::get('messej_danger')}}
                   </div>
                   @endif

                   @if(Session::has('messej_verified'))
                   <div class="alert alert-success">
                   {{Session::get('messej_verified')}}
                   </div>
                   @endif
                   @if(Session::has('messej_not_verified'))
                   <div class="alert alert-danger">
                   {{Session::get('messej_not_verified')}}
                   </div>
                   @endif
                <form action="{{route('updateCustomer', $editCustomer->id)}}" method="post">
                  @csrf
                  <div class="form-group m-1">
                      <label class="text-success" for="">Full Name<span class="text-danger"></span></label>
                      <input type="text" class="form-control" value="{{$editCustomer->full_name}}" name="full_name" placeholder="---" required>
                  </div>
                  <div class="form-group m-1">
                      <label class="text-success" for="">Email<span class="text-danger"></span></label>
                      <input type="email" class="form-control" value="{{$editCustomer->email}}" name="email" placeholder="---" required>
                  </div>
                  <div class="form-group m-1">
                      <label class="text-success" for="">Your Country<span class="text-danger"></span></label>
                      <input type="text" class="form-control" value="{{$editCustomer->country}}" name="country" placeholder="---" required>
                  </div>
                  <div class="form-group m-1">
                      <label class="text-success" for="">Address<span class="text-danger"></span></label>
                      <input type="text" class="form-control" value="{{$editCustomer->address}}" name="address" placeholder="---" required>
                  </div>
                  <div class="form-group m-1">
                      <label class="text-success" for="">City<span class="text-danger"></span></label>
                      <input type="text" class="form-control" value="{{$editCustomer->city}}" name="city" placeholder="---" required>
                  </div>
                  <div class="form-group m-1">
                      <label class="text-success" for="">Phone number<span class="text-danger"></span></label>
                      <input type="text" class="form-control" value="{{$editCustomer->phone}}" name="phone" placeholder="eg +255 ---" required>
                  </div>                 
