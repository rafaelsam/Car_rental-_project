...
<meta content="" name="description">
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="{{route('addnew')}}">Add new Car</a></li>
        </ul>
        ...
        <div class="row">
              @if(Session::has('flash_message'))
                   ...
                   <div class="container m-2">
                     <div class="row">
                     <form action="{{route('admn_search')}}" method="post">  
                       @csrf                   
                     <div class="d-flex col-lg-4">
                     <input style=" border-right: none;" class="form-control col-lg-4" type="text" name="all_search" id="" placeholder="chasis no, car name, model, etc">
  ...
  <tbody>
   ...
   <tr>
   <td>{{$data->id}}</td>
   <td class="text-primary"><b><u>{{$data->carName}}</u></b></td>
   <td>
     <img class="img-responsive" src="coverImages/{{$data->cover_p}}" style="width:120px; height:100px;" alt="">
     </td>
   <td class="text-warning"><b><i><u>{{$data->ProductionYear}}</u></i></b></td>
   <td> <a class="btn btn-success" href="{{route('view', $data->id)}}">View</a></td>
